...
const SignIn = () => {
  ...
  return (
    <AuthShell>
      ...
      {/* WhatsApp OTP — Primary (Bharat-first) */}
      <div className="mb-3 animate-fade-in">
        <button
          onClick={() => {
            setShowEmail(true);
            toast({ title: 'WhatsApp OTP launching soon', description: 'Use email sign-in for now — we\'ll notify you when WhatsApp is live.', variant: 'default' });
          }}
          className="w-full py-4 rounded-xl bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold font-body text-base shadow-lg flex items-center justify-center gap-3 transition-all hover:-translate-y-0.5"
        >
        ...
        <p className="text-center text-xs text-muted-foreground font-body mt-1.5">OTP on WhatsApp — instant, no password</p>
      </div>
